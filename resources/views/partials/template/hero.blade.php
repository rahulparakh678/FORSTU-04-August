...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active ">
     <a href="http://www.forstu.co/sdetails/24"> <img class="d-block w-100" src="{{asset('external/img/vds.png')}}" alt="First slide"  ></a>
        <div class="carousel-caption ">
          
        </div>
    </div>
    <div class="carousel-item ">
      <img class="d-block w-100" src="{{asset('external/img/a.png')}}" alt="First slide"  >
        <div class="carousel-caption ">

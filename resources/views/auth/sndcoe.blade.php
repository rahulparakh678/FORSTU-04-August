            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="course" class="col-md-4 col-form-label text-md-right">College</label>

                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course">
                                    <option value disabled="" selected>Please Select College</option>
                                    <option value="S. N. D. College of Engineering & Research Center">S. N. D. College of Engineering & Research Center</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="course" class="col-md-4 col-form-label text-md-right">Current Year</label>

                            <div class="col-md-6">
                                <select class="form-control" name="current_year" id="current_year">
                                    <option value disabled="" selected>Please Select Current Year</option>
                                    <option value="First Year">First Year</option>
                                    <option value="Second Year">Second year</option>
                                    <option value="Third Year">First Year</option>
                                    <option value="Fourth Year">Fourth year</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="course" class="col-md-4 col-form-label text-md-right">Category</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="SNDCOE" readonly autofocus>
                            </div>
                        </div>

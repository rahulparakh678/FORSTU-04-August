                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course">
                                    ...
                                    <option value="BIT BARSHI">Bhagwant Institute of Technology</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="BITBARSHI" readonly autofocus>
                            </div>
                        </div>

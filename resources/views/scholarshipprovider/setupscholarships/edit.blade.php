...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.setupscholarship.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action=" {{route('updatescholarship',$setupscholarship->id)}}" enctype="multipart/form-data">
            
            @csrf
            <div class="form-group">
                <label class="required" for="scheme_name">{{ trans('cruds.setupscholarship.fields.scheme_name') }}</label>
                <input class="form-control {{ $errors->has('scheme_name') ? 'is-invalid' : '' }}" type="text" name="scheme_name" id="scheme_name" value="{{ old('scheme_name', $setupscholarship->scheme_name) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('company_name') ? 'is-invalid' : '' }}" name="company_name_id" id="company_name_id">
                    @foreach($company_names as $id => $company_name)
                        <option value="{{ $id }}" {{ ($setupscholarship->company_name ? $setupscholarship->company_name->id : old('company_name_id')) == $id ? 'selected' : '' }}>{{ $company_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category_id" id="category_id">
                    @foreach($categories as $id => $category)
                        <option value="{{ $id }}" {{ ($setupscholarship->category ? $setupscholarship->category->id : old('category_id')) == $id ? 'selected' : '' }}>{{ $category }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('courses') ? 'is-invalid' : '' }}" name="courses[]" id="courses" multiple>
                    @foreach($courses as $id => $course)
                        <option value="{{ $id }}" {{ (in_array($id, old('courses', [])) || $setupscholarship->courses->contains($id)) ? 'selected' : '' }}>{{ $course }}</option>
                    @endforeach
                </select>
             ...
             <div class="form-group">
                ...
                <select class="form-control select2" name="gender_criteria" >
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('scheme_description') ? 'is-invalid' : '' }}" name="scheme_description" id="scheme_description">{!! old('scheme_description', $setupscholarship->scheme_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('eligibility_criteria') ? 'is-invalid' : '' }}" name="eligibility_criteria" id="eligibility_criteria">{{ old('eligibility_criteria', $setupscholarship->eligibility_criteria) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('benefits') ? 'is-invalid' : '' }}" name="benefits" id="benefits">{!! old('benefits', $setupscholarship->benefits) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('how_to_apply') ? 'is-invalid' : '' }}" name="how_to_apply" id="how_to_apply">{!! old('how_to_apply', $setupscholarship->how_to_apply) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('last_date') ? 'is-invalid' : '' }}" type="text" name="last_date" id="last_date" value="{{ old('last_date', $setupscholarship->last_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('docs_required') ? 'is-invalid' : '' }}" name="docs_required" id="docs_required">{!! old('docs_required', $setupscholarship->docs_required) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('student_count') ? 'is-invalid' : '' }}" type="text" name="student_count" id="student_count" value="{{ old('student_count', $setupscholarship->student_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scholarship_amount') ? 'is-invalid' : '' }}" type="text" name="scholarship_amount" id="scholarship_amount" value="{{ old('scholarship_amount', $setupscholarship->scholarship_amount) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scholarship_corpus') ? 'is-invalid' : '' }}" type="text" name="scholarship_corpus" id="scholarship_corpus" value="{{ old('scholarship_corpus', $setupscholarship->scholarship_corpus) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('terms_conditions') ? 'is-invalid' : '' }}" name="terms_conditions" id="terms_conditions">{!! old('terms_conditions', $setupscholarship->terms_conditions) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('contact_address') ? 'is-invalid' : '' }}" name="contact_address" id="contact_address">{!! old('contact_address', $setupscholarship->contact_address) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_email') ? 'is-invalid' : '' }}" type="email" name="contact_email" id="contact_email" value="{{ old('contact_email', $setupscholarship->contact_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_phone_number') ? 'is-invalid' : '' }}" type="text" name="contact_phone_number" id="contact_phone_number" value="{{ old('contact_phone_number', $setupscholarship->contact_phone_number) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Setupscholarship::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $setupscholarship->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>

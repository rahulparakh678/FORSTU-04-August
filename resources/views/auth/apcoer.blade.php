                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course">
                                    ...
                                    <option value="ANANTRAO PAWAR COLLEGE OF ENGINEERING & RESEARCH">ANANTRAO PAWAR COLLEGE OF ENGINEERING & RESEARCH</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="APCOER" readonly autofocus>
                            </div>
                        </div>
